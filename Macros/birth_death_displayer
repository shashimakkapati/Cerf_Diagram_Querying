...
# find source
cerf_final1 = FindSource('Cerf_final1')
...
# toggle interactive widget visibility (only when running from the GUI)
ShowInteractiveWidgets(proxy=cerf_final1.Transform)
...
# toggle interactive widget visibility (only when running from the GUI)
HideInteractiveWidgets(proxy=cerf_final1.Transform)
...
transform1.Transform.Scale = [2.962, 427.3744192900953, 1.0]

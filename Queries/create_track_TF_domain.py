...
import numpy as np
import math
print('''Click on 'Select points on' icon in the toolbar just above the Render view\n
Select a rectangle enclosing the point whose cerf track is desired\n
Go to View->Find data to get the coordinate of the point\n''')
...
vtpath=path[1:-4]+"_track_TF_query.vtp"
